...
X_train = read_csv("split_1234/X_train.csv",
                   col_type = cols(Q = col_factor(levels = c("Q1", "Q2", "Q3", "Q4")))
                   )

y_train = read_csv("split_1234/y_train.csv")

#log_chirp   es el promedio tranformado (log )de los datos chirps de los 3 dias anteriores chirp3_lag
